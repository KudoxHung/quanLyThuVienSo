...
function _EditCategoryDocumentDigital() {
        ...
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Typography.Title level={3}>
              Chỉnh sửa danh mục tài liệu số
            </Typography.Title>
...
export const EditCategoryDocumentDigital = WithErrorBoundaryCustom(
  _EditCategoryDocumentDigital,
);
