...
export function _DocumentDigitalByCategoryLayout() {
      ...
      <Row gutter={[24, 0]}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Title level={5}>Quản lý tài liệu số</Title>
...
export const DocumentDigitalByCategoryLayout = WithErrorBoundaryCustom(
  _DocumentDigitalByCategoryLayout,
);
