...
export function _CategoryDocumentDigitalLayout() {
  ...
  useEffect(() => {
    document.title = "Quản lý danh mục tài liệu số";
  }, []);
  ...
  useEffect(() => {
    const savedFilters = JSON.parse(
      localStorage.getItem("filtersDanhMucTaiLieuSo"),
    );
        ...
        return (
          <Tooltip title="xem tài liệu số">
            <PlusCircleOutlined
              ...
              onClick={(e) => {
                navigate(`/admin/danh-muc-tai-lieu-so/children/${record.id}`, {
                  state: {
        ...
        return (
          <Space size="small">
            <Button
              ...
              onClick={(e) => {
                e.preventDefault();
                navigate(`/admin/danh-muc-tai-lieu-so/edit/${record.id}`);
              }}
              icon={<EditOutlined />}
            >
              Chỉnh sửa
      ...
      <Row gutter={[24, 0]}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Title level={5}>Quản lý danh mục tài liệu số</Title>
            <Space
              style={{
                marginBottom: 16,
              }}
            >
              <Button
                onClick={(e) => navigate("/admin/danh-muc-tai-lieu-so/new")}
              >
                Thêm mới danh mục
              </Button>
            </Space>
...
export const CategoryDocumentDigitalLayout = WithErrorBoundaryCustom(
  _CategoryDocumentDigitalLayout,
);
