...
export function _DocumentDigitalByCategoryLayoutConnect() {
        ...
        books
          ...
          .catch((err) => {
            openNotificationWithIcon(
              "error",
              "Lấy danh tài liệu số  theo danh mục thất bại",
  ...
  const columns = [
    ...
    },
    {
      ...
      filters: Books.map((Books) => ({
        text:
          Books.document?.publishYear !== null
      ...
      render: (_, record) =>
        record.document?.publishYear !== null
      ...
      <Row gutter={[24, 0]}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Title level={5}>Quản lý tài liệu số dùng chung</Title>
...
export const DocumentDigitalByCategoryLayoutConnect = WithErrorBoundaryCustom(
  _DocumentDigitalByCategoryLayoutConnect,
);
