...
function _BooksByCategoryLayout() {
  ...
  useEffect(() => {
    document.title = `Danh mục - ${location?.state?.categoryName} `;
        ...
        books
          ...
          .catch((err) => {
            openNotificationWithIcon(
              "error",
              "Lấy danh sách sách theo danh mục thất bại",
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) =>
        record.document.price?.toLocaleString("it-IT", {
          style: "currency",
          currency: "VND",
        }),
    },
...
export const BooksByCategoryLayout = WithErrorBoundaryCustom(
  _BooksByCategoryLayout,
);
