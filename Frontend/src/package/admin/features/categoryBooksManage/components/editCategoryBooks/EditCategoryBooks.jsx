    ...
    documentType
      ...
      .catch((err) => {
        openNotificationWithIcon(
          "error",
          "Lấy thông tin sách theo id thất bại",
  ...
  const onFinish = (values) => {
    ...
    documentType
      ...
      .catch((err) => {
        openNotificationWithIcon(
          "error",
          "Cập nhật danh mục sách thất bại",
          err?.response?.data?.message || err?.message,
        );
        setBtnLoading(false);
      });
...
export const EditCategoryBooks = WithErrorBoundaryCustom(_EditCategoryBooks);
