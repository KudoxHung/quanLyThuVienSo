...
function _EditGroupVideoElearningSound({ Data, setVisible, setPostLength }) {
  ...
  const onFinish = async (values) => {
    try {
      const res = await GroupVesApis.UpdateGroupVes(values);
      if (res.success) {
        setVisible(false);
...
export const EditGroupVideoElearningSound = WithErrorBoundaryCustom(
  _EditGroupVideoElearningSound,
);
