...
import { getImageFilterForSizeImage } from "../../../../client/utils/filterImageConnect";
...
function _DocumentDigitalConnect() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Typography.Text
          style={{ color: record.document.isApproved ? "green" : "red" }}
        >
          {record.document.isApproved ? "Đã duyệt" : "Chưa duyệt"}
        </Typography.Text>
      ),
    },
    {
        ...
        return (
          <Space size="small">
            <Button
              ...
              icon={<EditOutlined />}
              disabled={record.document.isApproved}
            >
              Chỉnh sửa
            </Button>
            <Popconfirm
      ...
      <Row gutter={[24, 0]}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Title level={5}>Quản lý tài liệu điện tử dùng chung</Title>
            <Space
              style={{
                marginBottom: 16,
              }}
...
export const DocumentDigitalConnect = WithErrorBoundaryCustom(
  _DocumentDigitalConnect,
);
