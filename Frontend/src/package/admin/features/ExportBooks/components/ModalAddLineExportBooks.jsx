...
function _ModalAddLineExportBooks(props) {
  const {
    visible,
    setVisible,
    form,
  ...
  const columns = [
    ...
    {
      title: "Tình trạng",
      dataIndex: "statusIndividual",
      key: "statusIndividual",
...
export const ModalAddLineExportBooks = WithErrorBoundaryCustom(
  _ModalAddLineExportBooks,
);
