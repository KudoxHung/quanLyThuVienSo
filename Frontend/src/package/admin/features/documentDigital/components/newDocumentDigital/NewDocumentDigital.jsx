  ...
  const onFinish = (values) => {
    ...
    books
      ...
      .then(() => {
        ...
        setBtnLoading(false);
        navigate("/admin/khai-bao-tai-lieu");
      })
      .catch((err) => {
        openNotificationWithIcon(
          "error",
      ...
      <Row gutter={[24, 0]}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="mb-24">
          <Card bordered={false} className="criclebox h-full">
            <Typography.Title level={3}>Thêm tài liệu mới</Typography.Title>
            <Skeleton active loading={loading}>
              ...
              >
                <ProFormGroup>
                  ...
                  >
                    {/*<ProFormSwitch width="lg" name="isHavePhysicalVersion" label="Bản vật lý" size="large" value={true} disabled />*/}
                    <ProFormSwitch
                      width="lg"
                      name="isApproved"
                      label="Kiểm duyệt"
...
export const NewDocumentDigital = WithErrorBoundaryCustom(_NewDocumentDigital);
