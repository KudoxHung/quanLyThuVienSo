              ...
              >
                ...
                <ProForm.Group>
                  <Form.Item
                    label="Năm xuất bản"
                    name={"publishYear"}
                    //initialValue={book?.document?.publishYear ? moment(book.document.publishYear, "YYYY") : moment('2024', "YYYY")}
                  >
...
export const EditDocumentDigital =
  WithErrorBoundaryCustom(_EditDocumentDigital);
