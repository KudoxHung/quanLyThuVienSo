...
export const ContactAndIntroduction = {
  create: async (contactAndIntroduction) => {
    return await axiosClient.post(`/ContactAndIntroduction/InsertRule`, contactAndIntroduction);
  },
  update: async (contactAndIntroduction) => {
    return await axiosClient.post(`/ContactAndIntroduction/UpdateRule`, contactAndIntroduction);
  },
  ...
  SaveImageIntroduction: async (image) => {
    return await axiosClient.post(`/ContactAndIntroduction/SaveImageIntroduction`, image, {
      headers: {
