...
export const books = {
  ...
  getAllBook: async (pageSize, pageNumber) => {
    ...
    //DocumentType = 2 => newspaper, magazine
    return await axiosClient.get(
      `/Book/GetBookAll?pageSize=${pageSize}&pageNumber=${pageNumber}`,
    );
  },
  getAllListBookInportBook: async (
    pageSize,
    pageNumber,
    DocumentType = 1,
    searchDocName = null,
  ...
  apporeBook: async (id, isAppore) => {
    return await axiosClient.post(
      `/Book/ApporeBook?id=${id}&&isApprove=${isAppore}`,
    );
  },
  delete: async (id) => {
  ...
  InsertDocumentAndIndividualSample: async (book) => {
    return await axiosClient.post(
      `/Book/InsertDocumentAndIndividualSample`,
      book,
      {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  GetEncryptDocumentName: async (bookName) => {
    return await axiosClient.get(
      `/Book/GetEncryptDocumentName?bookName=${bookName}`,
    );
  },
  update: async (book) => {
  ...
  GetFileImageWordInsertBook: async (type) => {
    return await axiosClient.get(
      `/Book/GetFileImageWordInsertBook?type=${type}`,
      { responseType: "blob" },
    );
  },
  InsertBookAndIndividualByExcel: async (file) => {
    return await axiosClient.post(
      `/Book/InsertBookAndIndividualByExcel`,
      file,
      {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  GetBookExistIndividualCode: async (DocumentType) => {
    return await axiosClient.get(
      `/Book/GetBookExistIndividualCode?DocumentType=${DocumentType}`,
    );
  },
