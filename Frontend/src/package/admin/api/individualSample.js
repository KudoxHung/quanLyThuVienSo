...
export const individualSample = {
  ...
  getById: async (id) => {
    return await axiosClient.get(
      `/IndividualSample/GetIndividualSampleById?Id=${id}`,
    );
  },
  getByIdDocument: async (id) => {
    return await axiosClient.get(
      `/IndividualSample/GetIndividualSampleByIdDocument?Id=${id}`,
    );
  },
  create: async (individualSample) => {
    return await axiosClient.post(
      `/IndividualSample/InsertIndividualSample`,
      individualSample,
    );
  },
  update: async (individualSample) => {
    return await axiosClient.post(
      `/IndividualSample/UpdateIndividualSample`,
      individualSample,
    );
  },
  delete: async (id) => {
    return await axiosClient.post(
      `/IndividualSample/DeleteIndividualSample?id=${id}`,
    );
  },
  ...
  GetIndividualStockNotRepeat: async (id) => {
    return await axiosClient.get(
      `/IndividualSample/GetIndividualStockNotRepeat?IdDocument=${id}`,
    );
  },
  GetIndividualByDateNotRepeat: async (id) => {
    return await axiosClient.get(
      `/IndividualSample/GetIndividualByDateNotRepeat?IdDocument=${id}`,
    );
  },
  ...
  GetSpineByBarcode: async (barcode) => {
    return await axiosClient.get(
      `/IndividualSample/GetSpineByBarcode?barcode=${barcode}`,
    );
  },
  GetSpineByListIdIndividual: async (ListIdIndividual) => {
    return await axiosClient.get(
      `/IndividualSample/GetSpineByListIdIndividual?ListIdIndividual=${ListIdIndividual}`,
    );
  },
  DeleteIndividualSampleByList: async (ListIdIndividual) => {
    return await axiosClient.post(
      `/IndividualSample/DeleteIndividualSampleByList`,
      ListIdIndividual,
    );
  },
  CheckIdIndividualExitsInDocumentInvoice: async (ListIdIndividual) => {
    return await axiosClient.post(
      `/IndividualSample/CheckIdIndividualExitsInDocumentInvoice`,
      ListIdIndividual,
    );
  },
};
