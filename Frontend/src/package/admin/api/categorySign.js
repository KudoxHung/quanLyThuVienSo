...
export const categorySign = {
  ...
  update: async (categorySign) => {
    return await axiosClient.post(`/CategorySign/UpdateCategorySign`, categorySign);
  },
  delete: async (id) => {
    return await axiosClient.post(`/CategorySign/DeleteCategoryByID?id=${id}`);
  },
  hided: async (id, isHide) => {
    return await axiosClient.post(`/CategorySign/HideCategoryById?id=${id}&&check=${isHide}`);
  },
  ...
  CategorySignByDocument: async (id) => {
    return await axiosClient.get(`/CategorySign/CategorySignByDocument?idDocument=${id}`);
  }
};
