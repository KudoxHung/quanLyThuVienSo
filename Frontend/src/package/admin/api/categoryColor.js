...
export const categoryColor = {
  ...
  getAllNotPagination: async () => {
    return await axiosClient.get(
      `/v1/CatagoryColor/GetAllListCategoryColorNotPagination`,
    );
  },
  ...
  insert: async (categoryColor) => {
    return await axiosClient.post(
      `/v1/CatagoryColor/insertCategoryColor`,
      categoryColor,
    );
  },
  delete: async (categoryColor) => {
    return await axiosClient.post(
      `/v1/CatagoryColor/deleteCategoryColorById`,
      categoryColor,
    );
  },
  update: async (categoryColor) => {
    return await axiosClient.post(
      `/v1/CatagoryColor/updateCategoryColor`,
      categoryColor,
    );
  },
};
