...
export const Participant = {
  ...
  GetlistParticipantsByIdReceipt: async (id) => {
    return await axiosClient.get(`/Participant/GetlistParticipantsBy?IdReceipt=${id}`);
  },
  GetlistNameParticipants: async (pageSize, pageNumber) => {
    return await axiosClient.get(`/Participant/GetlistNameParticipants?pageSize=${pageSize}&pageNumber=${pageNumber}`);
  },
