...
function _CategoryVideoType() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await CategoryVesApis.GetAllCategoryVesByVideo(
          page.pageSize,
          page.pageNumber,
        );
        setCategory(res);
...
export const CategoryVideoType = WithErrorBoundaryCustom(_CategoryVideoType);
