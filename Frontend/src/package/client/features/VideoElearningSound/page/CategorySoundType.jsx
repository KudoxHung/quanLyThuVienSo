...
function _CategorySoundType() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await CategoryVesApis.GetAllCategoryVesBySound(
          page.pageSize,
          page.pageNumber,
        );
        setCategory(res);
  ...
  return (
    <div className="SoundType Container">
...
export const CategorySoundType = WithErrorBoundaryCustom(_CategorySoundType);
